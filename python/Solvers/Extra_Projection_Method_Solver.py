...
def Extra_Projection_Method_Solver(model_manager, T, sampling_dt,max_iter=1000, display=1, stop=2):
    ...
    for i in range(max_iter):
        ...
        y_assignment, current_path_costs = all_or_nothing(model_manager, new_x_k_assignment, od, None, sampling_dt*num_steps)
